...
int  dmrAesStoreKey(uint8_t keyId, const uint8_t *key32); /* store/replace one key, then reload; 1=ok */
...
static inline int  dmrAesStoreKey(uint8_t keyId, const uint8_t *key32){ (void)keyId; (void)key32; return 0; }
