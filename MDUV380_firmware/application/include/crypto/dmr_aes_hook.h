...
int  dmrAesGetDiag(uint8_t *out);                  /* copy RX diag block; returns byte count */
int  dmrAesGetLcRing(uint8_t *out);                /* copy captured LC ring; returns byte count */
/* TX */
...
static inline int  dmrAesGetDiag(uint8_t *o){ (void)o; return 0; }
static inline int  dmrAesGetLcRing(uint8_t *o){ (void)o; return 0; }
